...
load_config "druid.zk.paths.propertiesPath" ${DRUID_ZK_PATHS_PROPERTIESPATH:=${druid.zk.paths.base}/properties} "_common/common.runtime.properties"
load_config "druid.zk.paths.announcementsPath" ${DRUID_ZK_PATHS_ANNOUNCEMENTSPATH:=${druid.zk.paths.base}/announcements} "_common/common.runtime.properties"
load_config "druid.zk.paths.liveSegmentsPath" ${DRUID_ZK_PATHS_LIVESEGMENTSPATH:=${druid.zk.paths.base}/segments} "_common/common.runtime.properties"
load_config "druid.zk.paths.loadQueuePath" ${DRUID_ZK_PATHS_LOADQUEUEPATH:=${druid.zk.paths.base}/loadQueue} "_common/common.runtime.properties"
load_config "druid.zk.paths.coordinatorPath" ${DRUID_ZK_PATHS_COORDINATORPATH:=${druid.zk.paths.base}/coordinator} "_common/common.runtime.properties"
load_config "druid.zk.paths.servedSegmentsPath" ${DRUID_ZK_PATHS_SERVEDSEGMENTSPATH:=${druid.zk.paths.base}/servedSegments} "_common/common.runtime.properties"
load_config "druid.zk.paths.indexer.base" ${DRUID_ZK_PATHS_INDEXER_BASE:=${druid.zk.paths.base}/indexer} "_common/common.runtime.properties"
load_config "druid.zk.paths.indexer.announcementsPath" ${DRUID_ZK_PATHS_INDEXER_ANNOUNCEMENTSPATH:=${druid.zk.paths.indexer.base}/announcements} "_common/common.runtime.properties"
load_config "druid.zk.paths.indexer.tasksPath" ${DRUID_ZK_PATHS_INDEXER_TASKSPATH:=${druid.zk.paths.indexer.base}/tasks} "_common/common.runtime.properties"
load_config "druid.zk.paths.indexer.statusPath" ${DRUID_ZK_PATHS_INDEXER_STATUSPATH:=${druid.zk.paths.indexer.base}/status} "_common/common.runtime.properties"
...
load_config "druid.auth.authenticatorChain" ${DRUID_AUTH_AUTHENTICATORCHAIN:=["allowAll"]} "_common/common.runtime.properties"
load_config "druid.auth.authorizers" ${DRUID_AUTH_AUTHORIZERS:=["allowAll"]} "_common/common.runtime.properties"
load_config "druid.auth.unsecuredPaths" ${DRUID_AUTH_UNSECUREDPATHS:=[]} "_common/common.runtime.properties"
...
load_config "druid.escalator.type" ${DRUID_ESCALATOR_TYPE:="noop"} "_common/common.runtime.properties"
...
load_config "druid.startup.logging.maskProperties" ${DRUID_STARTUP_LOGGING_MASKPROPERTIES:=["password"]} "_common/common.runtime.properties"
...
load_config "druid.service" ${DRUID_SERVICE:=druid/broker} "broker/runtime.properties"
...
load_config "druid.service" ${DRUID_SERVICE:=druid/coordinator} "coordinator/runtime.properties"
...
load_config "druid.service" ${DRUID_SERVICE:=druid/historical} "historical/runtime.properties"
...
load_config "druid.segmentCache.infoDir" ${DRUID_SEGMENTCACHE_INFODIR:=${first_location}/info_dir} "historical/runtime.properties"
...
load_config "druid.service" ${DRUID_SERVICE:=druid/overlord} "overlord/runtime.properties"
