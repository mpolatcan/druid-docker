...
load_config "druid.bindOnHost" "${DRUID_BROKER_BINDONHOST:=false}" "broker/runtime.properties"
load_config "druid.plaintextPort" "${DRUID_BROKER_PLAINTEXT_PORT:=8082}" "broker/runtime.properties"
load_config "druid.tlsPort" "${DRUID_BROKER_TLS_PORT:=8282}" "broker/runtime.properties"
load_config "druid.service" "${DRUID_BROKER_SERVICE:=druid/broker}" "broker/runtime.properties"
...
load_config "druid.bindOnHost" "${DRUID_COORDINATOR_BINDONHOST:=false}" "coordinator/runtime.properties"
load_config "druid.plaintextPort" "${DRUID_COORDINATOR_PLAINTEXT_PORT:=8081}" "coordinator/runtime.properties"
load_config "druid.tlsPort" "${DRUID_COORDINATOR_TLS_PORT:=8281}" "coordinator/runtime.properties"
load_config "druid.service" "${DRUID_COORDINATOR_SERVICE:=druid/coordinator}" "coordinator/runtime.properties"
...
load_config "druid.bindOnHost" "${DRUID_HISTORICAL_BINDONHOST:=false}" "historical/runtime.properties"
load_config "druid.plaintextPort" "${DRUID_HISTORICAL_PLAINTEXT_PORT:=8083}" "historical/runtime.properties"
load_config "druid.tlsPort" "${DRUID_HISTORICAL_TLS_PORT:=8283}" "historical/runtime.properties"
load_config "druid.service" "${DRUID_HISTORICAL_SERVICE:=druid/historical}" "historical/runtime.properties"
...
load_config "druid.bindOnHost" "${DRUID_MIDDLEMANAGER_BINDONHOST:=false}" "middleManager/runtime.properties"
load_config "druid.plaintextPort" "${DRUID_MIDDLEMANAGER_PLAINTEXT_PORT:=8091}" "middleManager/runtime.properties"
load_config "druid.tlsPort" "${DRUID_MIDDLEMANAGER_TLS_PORT:=8291}" "middleManager/runtime.properties"
load_config "druid.service" "${DRUID_MIDDLEMANAGER_SERVICE:=druid/middlemanager}" "middleManager/runtime.properties"
...
load_config "druid.bindOnHost" "${DRUID_OVERLORD_BINDONHOST:=false}" "overlord/runtime.properties"
load_config "druid.plaintextPort" "${DRUID_OVERLORD_PLAINTEXT_PORT:=8090}" "overlord/runtime.properties"
load_config "druid.tlsPort" "${DRUID_OVERLORD_TLS_PORT:=8290}" "overlord/runtime.properties"
load_config "druid.service" "${DRUID_OVERLORD_SERVICE:=druid/overlord}" "overlord/runtime.properties"
...
load_config "druid.bindOnHost" "${DRUID_ROUTER_BINDONHOST:=false}" "router/runtime.properties"
load_config "druid.plaintextPort" "${DRUID_ROUTER_PLAINTEXT_PORT:=8888}" "router/runtime.properties"
load_config "druid.tlsPort" "${DRUID_ROUTER_TLS_PORT:=9088}" "router/runtime.properties"
load_config "druid.service" "${DRUID_BROKER_SERVICE:=druid/router}" "router/runtime.properties"
...
load_config "druid.router.coordinatorServiceName" "${DRUID_ROUTER_COORDINATORSERVICENAME:=druid/coordinator}" "router/runtime.properties"
load_config "druid.router.tierToBrokerMap" "${DRUID_ROUTER_TIERTOBROKERMAP:={\"_default_tier\":\"druid/broker\"\}}" "router/runtime.properties"
